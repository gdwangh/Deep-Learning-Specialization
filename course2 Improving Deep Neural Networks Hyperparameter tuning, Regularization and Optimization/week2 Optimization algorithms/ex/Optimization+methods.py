...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    if m % mini_batch_size != 0:
        ### START CODE HERE ### (approx. 2 lines)
        mini_batch_X = shuffled_X[:, mini_batch_size * num_complete_minibatches:] # None
        mini_batch_Y = shuffled_Y[:, mini_batch_size * num_complete_minibatches:] # None
        ### END CODE HERE ###
        mini_batch = (mini_batch_X, mini_batch_Y)
        mini_batches.append(mini_batch)
...
def initialize_velocity(parameters):
    ...
    for l in range(L):
        ### START CODE HERE ### (approx. 2 lines)
        v["dW" + str(l+1)] = np.zeros(parameters['W'+str(l+1)].shape) # None
        v["db" + str(l+1)] = np.zeros(parameters['b'+str(l+1)].shape) # None
        ### END CODE HERE ###
...
def initialize_adam(parameters) :
    ...
    ### START CODE HERE ### (approx. 4 lines)
        v["dW" + str(l+1)] = np.zeros(parameters["W"+str(l+1)].shape) # None
        v["db" + str(l+1)] = np.zeros(parameters["b"+str(l+1)].shape) # None
        s["dW" + str(l+1)] = np.zeros(parameters["W"+str(l+1)].shape) # None
        s["db" + str(l+1)] = np.zeros(parameters["b"+str(l+1)].shape) # None
    ### END CODE HERE ###
...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        ### START CODE HERE ### (approx. 2 lines)
        v_corrected["dW" + str(l+1)] = v["dW" + str(l+1)] / (1+beta1**t) # None
        v_corrected["db" + str(l+1)] = v["db" + str(l+1)] / (1+beta1**t) # None
        ### END CODE HERE ###

        # Moving average of the squared gradients. Inputs: "s, grads, beta2". Output: "s".
        ### START CODE HERE ### (approx. 2 lines)
        s["dW" + str(l+1)] = beta2 * s["dW" + str(l+1)] + (1-beta2) * (grads["dW"+str(l+1)]**2) # None
        s["db" + str(l+1)] = beta2 * s["db" + str(l+1)] + (1-beta2) * (grads["db"+str(l+1)]**2) # None
        ### END CODE HERE ###
        # Compute bias-corrected second raw moment estimate. Inputs: "s, beta2, t". Output: "s_corrected".
        ### START CODE HERE ### (approx. 2 lines)
        s_corrected["dW" + str(l+1)] = s["dW" + str(l+1)] / (1-beta2**t) # None
        s_corrected["db" + str(l+1)] = s["db" + str(l+1)] / (1-beta2**t) # None
        ### END CODE HERE ###
